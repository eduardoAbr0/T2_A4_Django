...
urlpatterns = [
    ...
    path('alumnos/', ListadoAlumno.as_view(template_name="alumnos/index.html"), name='listar'),
    path('alumnos/detalle/<int:pk>', DetalleAlumno.as_view(template_name="alumnos/detalle.html"), name='detalle'),
    path('alumnos/crear', CrearAlumno.as_view(template_name="alumnos/agregar.html"), name='crear'),
